...
BarWidget {
  ...
  function workspaceScreenName(workspace) {
  ...
  readonly property var visibleIds: {
    ...
    for (var i = 0; i < values.length; i++) {
      ...
      if (root.screenName !== "" && workspaceScreenName(workspace) !== root.screenName) continue
  ...
  GridLayout {
    ...
    columns: root.vertical ? 1 : Math.max(1, root.visibleIds.length)
