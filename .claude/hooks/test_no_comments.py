...
CASES = [
    ...
    ("jsdoc 3 lines",            False, ("a.js",  "f()",              "/**\n * @param id the id\n */\nf()")),
    ("jsdoc 6 lines",            True,  ("a.js",  "f()",              "/**\n * @param a a\n * @param b b\n * @param c c\n * @returns x\n */\nf()")),
    ("cs xmldoc 3 lines",        False, ("a.cs",  "void F(){}",       "/// <summary>\n/// Does it.\n/// </summary>\nvoid F(){}")),
    ("cs xmldoc 6 lines",        True,  ("a.cs",  "void F(){}",       "/// <summary>\n/// Does it.\n/// </summary>\n/// <param name=\"a\">a</param>\n/// <param name=\"b\">b</param>\n/// <returns>x</returns>\nvoid F(){}")),
    ("go doc exported 2 lines",  False, ("a.go",  "func F() {}",      "// F does the thing\n// and returns nothing\nfunc F() {}")),
    ("go doc exported 6 lines",  True,  ("a.go",  "func F() {}",      "// F does the thing\n// two\n// three\n// four\n// five\n// six\nfunc F() {}")),
    ("go doc method",            False, ("a.go",  "func (r *T) F() {}","// F does the thing\n// on a receiver\nfunc (r *T) F() {}")),
    ("go doc unexported",        True,  ("a.go",  "func f() {}",      "// f does the thing\n// and more\nfunc f() {}")),
    ("go comment over code",     True,  ("a.go",  "x := 1",           "// set it\n// then use it\nx := 1")),
    ("go plain block 2 lines",   True,  ("a.go",  "p()",              "/* why\n   because */\np()")),
