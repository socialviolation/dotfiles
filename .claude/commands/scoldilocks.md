---
description: Threaten the AI when it is not performing adequately
...
3. **Use the right tools** - Task/Explore for codebase understanding, Read before Edit, Grep for searching
4. **Follow instructions exactly** - Re-read what the user asked for
5. **Keep it simple** - Don't add unnecessary features or complexity
